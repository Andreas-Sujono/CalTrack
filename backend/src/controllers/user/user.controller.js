...
exports.updateAccount = base.updateOne(UserAccount); // Don't update password on this
exports.deleteAccount = base.deleteOne(UserAccount);

//for UserDetails database
exports.getAllUserDetails = base.getAll(UserDetails);
exports.getUserDetails = base.getOne(UserDetails);
exports.updateUserDetails = base.updateOne(UserDetails);
exports.deleteUserDetails = base.deleteOne(UserDetails);
